...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    overview:
      "EXPEDITION OVERVIEW\n\nThese unique natural history trips to the Devil's Teeth (the Island of the Great White Shark) focus on the history, geology and biology of the Greater Farallones and San Francisco Bay. We only book in fall when the white sharks return and the weather is clement for our passengers and students. We focus on shark conservation and the health of the entire marine ecosystem in our sanctuary.\n\nDEPARTURE DETAILS\n\nMeet at the Vessel AMIGO at Fisherman's Wharf (not Pier 39) by 07:30 to begin boarding for an 08:00 departure. The vessel is berthed along the historic Fisherman's wharf waterfront between Castagnolas and Tarantino's restaurants. Look for the EAT CRAB sign across the street. Return is by 4:30 PM but can go longer by as much as an hour if we are onto something spectacular.\n\nROUTE & WILDLIFE\n\nOnce leaving the Bay our mission is to travel up the Marin shoreline seeking feeding humpback whales and white sharks to surface view. We will investigate the Marin County shoreline as far as Drakes Bay and into deeper waters. However, we visit island waters in 'the zone' at Shark Alley where sharks prey on elephant seals and the chance of a predation event is higher than just about anywhere in the world.\n\nNATURAL HISTORY\n\nIn the Greater Farallones National Marine Sanctuary, 36 species of marine mammals are found, including 18 species of cetaceans (whales and dolphins) - most frequently gray whales, blue whales, and humpback whales. Five species of pinniped come to shore including northern elephant seal, harbor seal, Steller's sea lion, California sea lion, and northern fur seal. The islands protect a seabird colony of over 250,000 individuals from 12 nesting species including Western Gull, Brandt's Cormorant, Common Murre, Tufted Puffin, and Rhinoceros Auklet.\n\nIMPORTANT NOTES\n\n• This is a conservation and education wildlife trip, not explicitly a shark watching trip\n• Surface viewing only on US Coast Guard inspected vessel AMIGO\n• We are one of the few outfits permitted under NOAA's White Shark Stewardship Program\n• No shark attractants used - this is pure wildlife observation\n• Fish and Wildlife Regulations prohibit landing in the Refuge\n• No guarantee of seeing specific wildlife - this is Nature",
