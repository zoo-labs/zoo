...
function Carosuel() {
  ...
  return (
    <div className="bg-black text-center xl:px-52 lg:px-32 md:px-16 px-6 pt-32">
        ...
        <p className='text-gray-300 text-sm md:text-center text-left xl:text-xl pb-16 xl:px-52 lg:px-32 md:px-16'>The future upgrades will have powers, allow them to speak with you. play with you and much more to come!</p>
