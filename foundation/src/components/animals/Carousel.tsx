...
function Carosuel() {
  ...
  return (
    <div className="bg-black text-center xl:px-52 lg:px-32 md:px-16 px-6 pt-32">
        ...
        <p className='text-gray-300 text-sm md:text-center text-left xl:text-xl pb-16 xl:px-52 lg:px-32 md:px-16'>The future of these digital collectibles are more then what meets the eye, an ai chat feature will soon be available for all Zoo Animals!</p>
