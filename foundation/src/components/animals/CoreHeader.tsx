...
<path d="M11.1189 18.207H1.88103L0.341309 23.5001H12.6589L11.1189 18.207Z" fill="white"/>
        ...
        <div
          className="flex flex-col items-start gap-2 px-4 py-8 rounded bg-black lg:basis-3/5  border border-white rounded-xl"
          key={animal.id}
        >
          <h2 className="mb-8 text-3xl 2xl:text-7xl text-white font-bold text-left">
            {animal.name}
          </h2>
          ...
          <div className="w-full">
            ...
            <div className="flex flex-col text-white  items-center md:flex-row justify-evenly mt-8">
                <div
      ...
      <div className="pt-32 text-white w-full">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {utilities.map((data, index) => (
            <div
              className="border bg-black px-2 py-4 rounded-xl font-[600] text-[36px] flex items-center justify-between"
              key={index}
            >
              <p>{data?.title}</p>
