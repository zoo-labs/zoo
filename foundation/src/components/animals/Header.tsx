        ...
        <div className='relative md:w-1/2 max-md:w-full max-md:px-4 2xl:pr-32 xl:pr-28 lg:pr-24 md:pr-16'>
            <ReactCardFlip isFlipped={flip}
              ...
              <Image
                  ...
                  alt=''
              /> */}
              <video autoPlay loop muted playsInline className="border rounded-xl p-1" src={front_m}>
                <source src={front}  type="video/webm"/>
                <source src={front_m}  type="video/mp4"/>
                
              </video>
              <video autoPlay loop muted playsInline className="border rounded-xl p-1" src={back_m}>
              <source src={back}  type="video/webm"/>
                <source src={back_m}  type="video/mp4"/>
              </video>
            </ReactCardFlip>
            <div className={`absolute bottom-4 ${flip ? 'btn-flex' : ''} md:right-20 lg:right-28 xl:right-32 2xl:right-36 max-md:right-8 cursor-pointer max-md:right-4 w-[45px] h-[45px] flex justify-center bg-white rounded-full`} onClick={() => setFlip(!flip)}>
