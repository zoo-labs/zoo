  ...
  return (
    <div className="bg-black md:px-24 lg:px-32 xl:px-40 2xl:px-64">
      ...
      <div className='max-md:hidden flex items-center justify-center space-x-8 collect-link'>
        <Link href="/animals/red_wolf" className={`text-white px-3 border hover:rounded-full border-black hover:border-white py-2 ${ title == "Red Wolf" ? 'active' : ''} text-sm font-medium`}>Red Wolf</Link>
        <Link href="/animals/nubian_giraffe" className={`text-white border hover:rounded-full border-black hover:border-white px-3 py-2 ${ title == "Nubian Giraffe" ? 'active' : ''} text-sm font-medium`}>Nubian Giraffe</Link>
        <Link href="/animals/amur_leopard" className={`text-white px-3 border hover:rounded-full border-black hover:border-white py-2 ${ title == "Amur Leopard" ? 'active' : ''} text-sm font-medium`}>Amur Leopard</Link>
        <Link href="/animals/pygmy_hippo" className={`text-white px-3 border hover:rounded-full border-black hover:border-white py-2 ${ title == "Pygmy Hippo" ? 'active' : ''} text-sm font-medium`}>Pygmy Hippo</Link>
        <Link href="/animals/siberian_tiger" className={`text-white px-3 border hover:rounded-full border-black hover:border-white py-2 ${ title == "Siberian Tiger" ? 'active' : ''} text-sm font-medium`}>Siberian Tiger</Link>
        <Link href="/animals/sumatran_elephant" legacyBehavior className={`text-white border hover:rounded-full border-black hover:border-white px-3 py-2 ${ title == "Sumatran Elephant" ? 'active' : ''} text-sm font-medium`}>Sumatran Elephant</Link>
        <Link href="/animals/javen_rhino" className={`text-white px-3 border hover:rounded-full border-black hover:border-white py-2 ${ title == "Javan Rhino" ? 'active' : ''} text-sm font-medium`}>Javan Rhino</Link>
      </div>
    </div>
  );
}
