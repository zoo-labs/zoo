    ...
    <div className="bg-black md:px-24 lg:px-32 xl:px-40 2xl:px-64">
      <div className="flex max-md:flex-col items-center justify-between py-20">
        <div className='relative md:w-1/2 max-md:w-full 2xl:pr-32 xl:pr-28 lg:pr-24 md:pr-16'>
            ...
            <div className='absolute bottom-4 md:right-36 cursor-pointer max-md:right-4 w-[45px] h-[45px] flex justify-center bg-white rounded-full' onClick={() => setFlip(!flip)}>
      ...
      <div className='max-md:hidden flex items-center justify-center space-x-8 collect-link'>
        <Link href="/animals/red_wolf" className={`text-white px-3 border hover:rounded-full border-black hover:border-white py-2 ${ title == "Red Wolf" ? 'active' : ''} text-sm font-medium`} legacyBehavior><a>Red Wolf</a></Link>
        <Link href="/animals/nubian_giraffe" className={`text-white border hover:rounded-full border-black hover:border-white px-3 py-2 ${ title == "Nubian Giraffe" ? 'active' : ''} text-sm font-medium`} legacyBehavior><a>Nubian Giraffe</a></Link>
        <Link href="/animals/amur_leopard" className={`text-white px-3 border hover:rounded-full border-black hover:border-white py-2 ${ title == "Amur Leopard" ? 'active' : ''} text-sm font-medium`} legacyBehavior><a>Amur Leopard</a></Link>
        <Link href="/animals/pygmy_hippo" className={`text-white px-3 border hover:rounded-full border-black hover:border-white py-2 ${ title == "Pygmy Hippo" ? 'active' : ''} text-sm font-medium`} legacyBehavior><a>Pygmy Hippo</a></Link>
        <Link href="/animals/siberian_tiger" className={`text-white px-3 border hover:rounded-full border-black hover:border-white py-2 ${ title == "Siberian Tiger" ? 'active' : ''} text-sm font-medium`} legacyBehavior><a>Siberian Tiger</a></Link>
        <Link href="/animals/sumatran_elephant" className={`text-white border hover:rounded-full border-black hover:border-white px-3 py-2 ${ title == "Sumatran Elephant" ? 'active' : ''} text-sm font-medium`} legacyBehavior><a>Sumatran Elephant</a></Link>
        <Link href="/animals/javen_rhino" className={`text-white px-3 border hover:rounded-full border-black hover:border-white py-2 ${ title == "Javan Rhino" ? 'active' : ''} text-sm font-medium`} legacyBehavior><a>Javan Rhino</a></Link>
      </div>
    </div>
  );
}
