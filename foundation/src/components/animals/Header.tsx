  ...
  return (
    <div className="bg-black md:px-16 lg:px-32 xl:px-40 2xl:px-64">
      ...
      <div className='max-md:hidden flex items-center justify-center space-x-8 collect-link'>
        ...
        <Link href="/animals/sumatran_elephant" legacyBehavior className={`text-white text-center border hover:rounded-full border-black hover:border-white px-3 py-2 ${ title == "Sumatran Elephant" ? 'active' : ''} text-sm font-medium`}>Sumatran Elephant</Link>
