  ...
  return (
    <div className="bg-black md:pt-52 max-md:py-32" id='volunteer'>
      <div className="flex max-md:flex-col max-md:flex-col-reverse items-center justify-between">
        <div className='w-1/2 max-md:w-full flex flex-col justify-between  max-md:px-12 max-md:pt-4 xl:pl-48 lg:pl-16 md:pl-8 md:pr-4 xl:pr-52'>
            ...
            <p className='text-white md:text-lg lg:text-xl xl:text-2xl lg:pb-12 md:pb-6'>Share your details so we can get in touch!</p>
