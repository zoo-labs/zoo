...
function TradingCard() {
  return (
    <div className="bg-black pb-32 xl:px-64 lg:px-32 md:px-16 px-4">
      ...
      <div className="flex items-center justify-between md:pt-20 flex-row-reverse">
        <div className='md:w-1/2 lg:pl-32 pl-8'>
            {/* <Image
                className='intro-bg'
        ...
        <div className='w-1/2 max-md:w-full flex flex-col justify-between'>
            ...
            <Link href='/animals/amur_leopard'  className='flex items-center md:pt-10 cursor-pointer text-white md:text-sm lg:text-md xl:text-lg max-md:pb-10'>
              <>
