  ...
  return (
    <div className="bg-black pt-32">
      <div className='flex justify-between space-x-16'>
        ...
        <div className='w-2/3 flex flex-col pr-48 pl-32'>
            ...
            <p className='text-white md:text-lg lg:text-xl xl:text-2xl max-md:pb-10'>Join our newsletter for events and progress reports.</p>
            <div className='flex items-center justify-between mt-10 space-x-16'>
