...
function Navbar() {
  ...
  return (
      <nav className="bg-white border-b border-gray-200">
        <div className="max-md:fixed max-md:w-full max-md:left-0 max-md:z-[999] max-md:bg-white max-md:border-b max-md:border-gray-200 px-4 sm:px-6 lg:px-8 xl:px-12">
