        ...
        <div className='w-1/2 max-md:w-full flex flex-col justify-between  px-8 xl:pl-32 lg:pl-16 md:pl-8 xl:pr-48'>
            ...
            { type == '2' ? (
              ...
              <div className='flex items-center md:pt-10 max-md:pt-4 xl:space-x-16 lg:space-x-12 md:space-x-8'>
                <Link href='#volunteer' className='flex items-center cursor-pointer text-white md:text-sm lg:text-md xl:text-lg max-md:pb-10' legacyBehavior>
                  <a>
                ...
                <Link href='/donation'  rel="noopener noreferrer" target="_blank" className='flex items-center cursor-pointer text-white md:text-sm lg:text-md xl:text-lg max-md:pb-10' legacyBehavior>
                  <a>
                ...
                <Link href='/about' className='flex items-center cursor-pointer text-white md:text-sm lg:text-md xl:text-lg max-md:pb-10 hidden md:flex' legacyBehavior>
                  <a>
