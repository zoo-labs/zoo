    ...
    <div className="bg-black py-52 max-md:py-0">
        <div className='w-full text-center items-center flex flex-col justify-between'>
            ...
            <Image
                ...
                alt=''
            />
            <div className='flex max-md:flex-col max-md:pt-8 items-center justify-center md:space-x-6'>
                ...
                <a className='flex items-center cursor-pointer text-white md:text-sm lg:text-md xl:text-lg max-md:pb-6'>
