      ...
      <div className='flex items-center justify-between py-20  lg:space-x-16 2xl:space-x-32 space-x-8'>
        ...
        <div className='w-1/2 max-md:w-full max-md:z-10 max-md:pt-[280px] flex flex-col  max-md:pl-15 max-md:pr-15   lg:pr-8'>
            ...
            <div className='flex items-center justify-between mt-10'>
                <Link href='/getinvolved#volunteer' className='flex items-center cursor-pointer text-white md:text-sm lg:text-md xl:text-xl max-md:pb-10' legacyBehavior>
                  <a>
                ...
                <Link href='/donation' className='flex items-center cursor-pointer text-white md:text-sm lg:text-md xl:text-lg max-md:pb-10' legacyBehavior>
                  <a>
                ...
                <Link href='/animals/red_wolf' className='flex items-center cursor-pointer text-white md:text-sm lg:text-md xl:text-lg max-md:pb-10' legacyBehavior>
                  <a>
    ...
    <div className='bg-black flex flex-col hidden max-md:block px-4'>
        ...
        <div className='max-md:w-full aspect-square relative flex flex-col items-center justify-between border rounded-xl border-white '>
            <video
                ...
                autoPlay loop
            ></video>
            <Link href='/animals/red_wolf' className='flex items-center absolute bottom-[0px] cursor-pointer text-white md:text-sm lg:text-md xl:text-lg max-md:pb-10' legacyBehavior>
              <a>
