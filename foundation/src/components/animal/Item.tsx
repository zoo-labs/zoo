      ...
      {animals.map((data, index) => (
        <div className='relative max-md:w-full flex flex-col items-center justify-between  border rounded-xl border-white space-y-8'>
            ...
            <ModelViewer className='aspect-square'
              ...
              glb={data.glb}
            ></ModelViewer>
            <Link href={data.href} className='absolute w-full items-center bottom-0 flex justify-center cursor-pointer text-white md:text-sm lg:text-md xl:text-xl max-md:pb-10 pb-8'>
