    ...
    <div className="bg-black">
      ...
      {comments.map((data, index) => (
        <div className='max-md:w-full flex flex-col justify-between w-1/4 px-5'>
            <h1 className='text-white md:text-3xl xl:text-4xl max-md:text-2xl'>{data.title}</h1>
            <p className='text-white md:text-md lg:text-lg xl:text-xl py-10 max-md:py-4'>{data.comment}</p>
            <div className='flex items-center text-white md:text-md lg:text-lg xl:text-xl max-md:pb-10'>
