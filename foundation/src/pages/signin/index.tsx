    ...
    <Layout>
        ...
        <div className='bg-black py-32 text-white'>
          <div className='md:w-[500px] mx-auto w-full rounded-3xl px-12 md:border border-white py-8 flex flex-col'>
            ...
            <button className='mt-8 rounded-full py-2 px-4 text-lg bg-[#3C9465]'>Sign In</button>
            <Link href='/forgot-password' className='text-[#3c9465] text-center mt-4'>Forgot the password?</Link>
            ...
            <div className='flex items-center justify-center space-x-2 mt-8'>
              ...
              <Link href='/signup' className='text-[#3c9465] text-sm'>Sign Up</Link>
            </div>
          </div>
        </div>
        <Footer />
