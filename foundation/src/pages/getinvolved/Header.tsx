...
function Header() {
  return (
    <div className="bg-black flex flex-col relative">
      ...
      <p className='text-white md:absolute md:w-1/4  max-md:px-8 max-md:pt-8 text-md bottom-0 left-[2rem]'>Supporting endangered species via human endeavors and virtual animal sales.</p>
