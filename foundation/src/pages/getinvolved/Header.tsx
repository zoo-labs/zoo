...
function Header() {
  return (
    <div className="bg-black flex flex-col relative max-md:pt-20">
      ...
      <p className='text-white md:absolute xl:w-1/4 md:w-1/2 max-md:px-8 max-md:pt-8 text-xl bottom-0 left-[2rem]'>Supporting endangered species via human endeavors and virtual animal sales.</p>
