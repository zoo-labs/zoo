...
import { CurrencyAmount, JSBI, Token, USDC, ZERO } from "@zoolabs/sdk";
          ...
          <div className="flex flex-col space-y-2">
            {farm?.rewards?.map((reward, i) => (
              <div key={i} className="flex items-center space-x-2">
                ...
                {i === 0 && (
                  <Typography>
                    {formatNumber(pendingSushi?.toSignificant(6) ?? 0)}
                  </Typography>
                )}
                {i === 1 && (
