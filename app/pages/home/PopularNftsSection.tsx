    ...
    <section>
      <div className="max-w-7xl mx-auto px-6 lg:pb-20">
        <div className="flex flex-col items-center">
          <h2 className="text-2xl md:text-2xl lg:text-5xl text-center mb-4 font-semibold">Popular NFTs</h2>
        ...
        <div className="flex flex-col items-center lg:flex-row lg: justify-between lg:gap-4">
          <NftCard
            image={<Image src="/img/girrafe.png" width={217} height={482} alt="" />}
            name="Girrafe (1589)"
            price="500k"
            address="0x070...09cb"
            days="3"
          ...
          />
          <NftCard
            image={<Image src="/img/tiger-nft.png" width={276} height={373} alt="" />}
          ...
          />
          <NftCard
            image={<Image src="/img/hippo.png" width={259} height={339} alt="" />}
          ...
          />
          <NftCard
            image={<Image src="/img/leopard.png" width={292} height={369} alt="" />}
