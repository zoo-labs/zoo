      ...
      <div className="px-6 py-16 lg:mt-10">
          ...
          <div className="relative w-screen h-screen flex flex-col justify-center items-center ">
            <div className="big-circle">
              ...
              <div
                ...
                onMouseEnter={() => displayContent('Your NFT Egg to reveal the animal within and learn about it')}
              ...
              <div
                ...
                onMouseEnter={() => displayContent('Your animal $ZOO to increase the value of your animal NFT.')}
                onMouseOut={() => displayContent('')}
                // style={hovered ? style : undefined}
              >
                <Image
              ...
              <div
                ...
                onMouseEnter={() =>
                  displayContent('Your fully mature animal to mint new Egg NFT’s. Breed the animals up to 6x.')
                }
                onMouseOut={() => displayContent('')}
                // style={hovered ? style : undefined}
              >
              ...
              <div
                ...
                onMouseEnter={() =>
                  displayContent('Your animal and watch it transition through its different stages of maturity.')
                }
                onMouseOut={() => displayContent('')}
                // style={hovered ? style : undefined}
              >
        ...
        <div className="flex flex-col items-center max-w-7xl px-6 mx-auto lg:mt-20">
          ...
          <p className="max-w-3xl mx-auto text-center mb-6 md:mb-8 lg:text-xl">
            Each animal NFT uses blockchain technology to establish a verified and public proof of ownership. This
            establishes credibility for each NFT and its unchangeable nature.
          </p>
          <div
