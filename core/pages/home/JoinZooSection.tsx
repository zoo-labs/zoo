  ...
  return (
    <section className="bg-purple100" id="newsletter">
      <div className="flex flex-col items-center justify-center px-6 py-16 mx-auto max-w-7xl">
        <h2 className="mb-6 text-3xl font-semibold text-center lg:text-5xl">Join the ZOO family!</h2>
        <p className="mb-4 text-xl">Follow us on social media</p>
        <div className="flex items-center mb-6">
          <a href="https://mobile.twitter.com/zoo_labs" target="_blank" rel="noreferrer" className="mr-8">
            <Image src="/img/twitter-large.svg" width={32} height={32} alt="" />
          </a>
          <a href="https://t.me/RealZoolabs" target="_blank" rel="noreferrer" className="mr-8">
            <Image src="/img/telegram-large.svg" width={32} height={32} alt="" />
          </a>
          <a
            ...
            className="mr-8"
          >
            <Image src="/img/instagram-large.svg" width={32} height={32} alt="" />
          </a>
          <a href="https://discord.com/invite/43m9Sstd" target="_blank" rel="noreferrer" className="mr-8">
            <Image src="/img/discord-large.svg" width={32} height={32} alt="" />
          </a>
          <a href="https://zoolabsofficial.medium.com/" target="_blank" rel="noreferrer" className="mr-8">
