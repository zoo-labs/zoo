import { Currency, CurrencyAmount, Pair, Percent, Token } from "@zoolabs/zdk";
...
export default function CurrencyInputPanel({
  ...
  return (
    <div
      id={id}
      className={classNames(hideInput ? "p-2" : "p-3", "rounded bg-dark-900")}
    >
      <div className="flex space-x-3">
        ...
        {!hideInput && (
          <div
            className={
              "flex flex-grow items-center w-full space-x-3 rounded focus:bg-dark-700 p-3 sm:w-3/5"
            }
          >
            <>
              ...
              {!hideBalance && currency && currencyBalance ? (
                <div className="flex flex-col">
                  ...
                  >
                    {formatCurrencyAmount(currencyBalance, 4)}{" "}
                    {currency?.symbol}
                  </div>
