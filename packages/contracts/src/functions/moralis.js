const ZooKeeper = {
  ...
  "transactionHash": "0xe80cebfa2c80dfcd62342ab049c1572cdce104cb4d2c03bec9b80ec4a2bfcc34",
  "receipt": {
    "to": null,
    ...
    "transactionIndex": 0,
    "gasUsed": "4314319",
    "logsBloom": "",
    "blockHash": "0xe37a873f634161ca266924b4f39dc8d8b120c82259918f4f04a815edd5dd22f5",
    "transactionHash": "0xe80cebfa2c80dfcd62342ab049c1572cdce104cb4d2c03bec9b80ec4a2bfcc34",
    "logs": [
      {
        "transactionIndex": 0,
    ...
    "blockNumber": 4,
    "cumulativeGasUsed": "4314319",
    "status": 1,
    "byzantium": true
  },
  "args": [],
  "solcInputHash": "60492145d44f7bd53097b30bc5aa95fc",
  ...
  "storageLayout": {
    "storage": [
      ...
      },
      {
        ...
        "offset": 0,
        "slot": "4",
        "type": "t_mapping(t_uint256,t_struct(Token)19966_storage)"
      },
      {
        "astId": 7994,
        "contract": "src/ZooKeeper.sol:ZooKeeper",
    ...
    "types": {
      ...
      "t_contract(IMarket)19715": {
        "encoding": "inplace",
        "label": "contract IMarket",
        "numberOfBytes": "20"
      },
      "t_contract(IMedia)19895": {
        "encoding": "inplace",
      ...
      "t_mapping(t_uint256,t_struct(Token)19966_storage)": {
        "encoding": "mapping",
        "key": "t_uint256",
        "label": "mapping(uint256 => struct IZoo.Token)",
        "numberOfBytes": "32",
        "value": "t_struct(Token)19966_storage"
      },
      "t_string_storage": {
        "encoding": "bytes",
        "label": "string",
      ...
      "t_struct(BidShares)19573_storage": {
        "encoding": "inplace",
      ...
      "t_struct(MediaData)19741_storage": {
        "encoding": "inplace",
      ...
      "t_struct(Parents)19929_storage": {
        "encoding": "inplace",
        ...
        "members": [
          {
            ...
            "offset": 0,
            "slot": "0",
            "type": "t_struct(Rarity)19915_storage"
          },
          {
            "astId": 19940,
            "contract": "src/ZooKeeper.sol:ZooKeeper",
          ...
          },
          {
            ...
            "offset": 0,
            "slot": "10",
            "type": "t_struct(Parents)19929_storage"
          },
          {
            "astId": 19956,
            "contract": "src/ZooKeeper.sol:ZooKeeper",
            ...
            "offset": 0,
            "slot": "14",
            "type": "t_struct(Breed)19920_storage"
          },
          {
            "astId": 19959,
            "contract": "src/ZooKeeper.sol:ZooKeeper",
            ...
            "offset": 0,
            "slot": "16",
            "type": "t_struct(Meta)19934_storage"
          },
          {
            "astId": 19962,
            "contract": "src/ZooKeeper.sol:ZooKeeper",
            ...
            "offset": 0,
            "slot": "18",
            "type": "t_struct(MediaData)19741_storage"
          },
          {
            "astId": 19965,
            "contract": "src/ZooKeeper.sol:ZooKeeper",
            ...
            "offset": 0,
            "slot": "22",
            "type": "t_struct(BidShares)19573_storage"
          }
        ],
        "numberOfBytes": "800"
      },
