...
contract ZooMedia is Media, Ownable {
    ...
    enum Animal{ PUG, BUTTERFLY, KITTEN, TURTLE, PENGUIN, ORCA, ELK, PANDA, GORILLA, ELEPHANT, LION, BEAR, SHARK, BLOBFISH, NAKED_MOLE_RAT,
                ...
                PUGITTEN,BUTTERFLITTEN,KITTEN,TURKITTEN,PENGKITTY,DUCKITTEN,ORKITTEN,ELKITTEN,PANDACAT,GORKITTEN,ELEPHITTEN,LITTEN,BEARTTEN,SHARKITTEN,BLOB_KITTEN,NAKED_MOLE_KITTEN,
    ...
    mapping (uint256[2] => uint256[2]) public hybrid_pair_map;
    mapping (uint256 => string) public animal_id_map;
