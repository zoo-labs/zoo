...
interface CryptoAnimalInterface extends ethers.utils.Interface {
  functions: {
    ...
    "didHatch(uint256)": FunctionFragment;
    ...
    "hatch(uint256)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "hatch", values: [BigNumberish]): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "didHatch", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "hatch", data: BytesLike): Result;
  ...
  events: {
    ...
    "AuctionEnded(uint256,address,address,uint256)": EventFragment;
    "HighestBidIncreased(uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "hatched"): EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "newEgg"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "priceUpdated"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "tokenSold"): EventFragment;
}

export class CryptoAnimal extends Contract {
  ...
  interface: CryptoAnimalInterface;
  ...
  didHatch(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
  ...
  callStatic: {
    ...
    hatch(_tokenId: BigNumberish, overrides?: CallOverrides): Promise<boolean>;
  ...
  filters: {
    ...
    AuctionEnded(
      ...
      { tokenId: BigNumber; seller: string; winner: string; amount: BigNumber }
    >;
    ...
    newEgg(
      ...
      [BigNumber, BigNumber, BigNumber],
      { sireId: BigNumber; matronId: BigNumber; tokenId: BigNumber }
    >;
