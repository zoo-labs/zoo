...
interface CryptoAnimalAdminInterface extends ethers.utils.Interface {
  functions: {
...
export class CryptoAnimalAdmin extends Contract {
  ...
  interface: CryptoAnimalAdminInterface;
