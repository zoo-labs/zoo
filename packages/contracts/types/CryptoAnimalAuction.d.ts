...
interface CryptoAnimalAuctionInterface extends ethers.utils.Interface {
  functions: {
...
export class CryptoAnimalAuction extends Contract {
  ...
  interface: CryptoAnimalAuctionInterface;
