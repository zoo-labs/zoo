...
import { Market, MarketFactory, Media, MediaFactory } from '@zoolabs/contracts/dist/typechain'
...
export class Zoo {
  ...
  /**
   * Fetches the content hash for the specified media on the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Fetches the metadata hash for the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Fetches the content uri for the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Fetches the metadata uri for the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Fetches the creator for the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Fetches the current bid shares for the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Fetches the current ask for the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Fetches the current bid for the specified bidder for the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   * @param bidder
   */
  ...
  /**
   * Updates the content uri for the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   * @param tokenURI
   */
  ...
  /**
   * Updates the metadata uri for the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   * @param metadataURI
   */
  ...
  /**
   * Mints a new piece of media on an instance of the Zoo Media Contract
   * @param mintData
   * @param bidShares
   */
  public async mint(
  ...
  /**
   * Sets an ask on the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   * @param ask
   */
  ...
  /**
   * Sets a bid on the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   * @param bid
   */
  ...
  /**
   * Removes the ask on the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Removes the bid for the msg.sender on the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Accepts the specified bid on the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   * @param bid
   */
  ...
  /**
   * Revokes the approval of an approved account for the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Burns the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Fetches the total balance of media owned by the specified owner on an instance of the Zoo Media Contract
   * @param owner
   */
  ...
  /**
   * Fetches the owner of the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Fetches the mediaId of the specified owner by index on an instance of the Zoo Media Contract
   * @param owner
   * @param index
   */
  ...
  /**
   * Fetches the total amount of non-burned media that has been minted on an instance of the Zoo Media Contract
   */
  ...
  /**
   * Fetches the mediaId by index on an instance of the Zoo Media Contract
   * @param index
   */
  ...
  /**
   * Fetches the approved account for the specified media on an instance of the Zoo Media Contract
   * @param mediaId
   */
  ...
  /**
   * Fetches if the specified operator is approved for all media owned by the specified owner on an instance of the Zoo Media Contract
   * @param owner
   * @param operator
   */
  ...
  /**
   * Grants approval to the specified address for the specified media on an instance of the Zoo Media Contract
   * @param to
   * @param mediaId
   */
  ...
  /**
   * Grants approval for all media owner by msg.sender on an instance of the Zoo Media Contract
   * @param operator
   * @param approved
   */
  ...
  /**
   * Returns the EIP-712 Domain for an instance of the Zoo Media Contract
   */
  ...
  /**
   * Throws an error if called on a readOnly == true instance of Zoo Sdk
   * @private
   */
