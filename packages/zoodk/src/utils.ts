...
export function chainIdToNetworkName(chainId: number): string {
  ...
  invariant(false, `chainId ${chainId} not officially supported by the Zoo Protocol`)
}
...
/**
 * Signs a Zoo Permit Message as specified by EIP-712
 *
 * @param owner
 * @param toAddress
 * @param mediaId
...
/**
 * Recovers the address of the private key that signed the Zoo Permit Message
 *
 * @param toAddress
 * @param mediaId
 * @param nonce
...
/**
 * Recovers the address of the private key that signed a Zoo MintWithSig Message
 *
 * @param contentHash
 * @param metadataHash
...
/**
 * Signs a Zoo MintWithSig Message as specified by EIP-712
 *
 * @param owner
 * @param contentHash
 * @param metadataHash
