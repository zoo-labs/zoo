...
/**
 * This schema describes version 20210221 of the metadata standard for the amulet poem format, designed for the Zoo protocol.
 */
export interface Amulet20210221 {
  ...
  name: string;
  /**
   * The text of the amulet. You should include this if possible, but, in this metadata version, it's not formally required. The text at the contentURI in the Zoo NFT is considered the canonical version.
   */
  poemText?: string;
  /**
