...
export namespace Moralis {
  ...
  class Web3 extends NativeWeb3 {
    static eth: any
    static enable: (options?: {provider?:  "walletconnect" | "wc"}) => any;
    ...
    static on: (eventName: any, cb: any) => any;
    static getSigningData: () => any;

    static onConnect: (cb: (values: any) => any) => any;
    static onDisconnect: (cb: (values: any) => any) => any;
    static onChainChanged: (cb: (values: any) => any) => any;
    static onAccountsChanged: (cb: (values: string) => any) => any;
  }
  ...
  function web3ByChain(string): Web3;
}

type Moralis = typeof Moralis;
