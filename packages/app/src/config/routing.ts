...
export const BASES_TO_CHECK_TRADES_AGAINST: ChainTokenList = {
  ...
  [ChainId.AVALANCHE]: [...WRAPPED_NATIVE_ONLY[ChainId.AVALANCHE], AVALANCHE.DAI, AVALANCHE.USDT, AVALANCHE.WBTC, AVALANCHE.WETH],
  [ChainId.HARMONY]: [...WRAPPED_NATIVE_ONLY[ChainId.HARMONY], HARMONY.DAI, HARMONY.USDC, HARMONY.USDT, HARMONY.WBTC, HARMONY.WETH],
  ...
  [ChainId.CELO]: [...WRAPPED_NATIVE_ONLY[ChainId.CELO], CELO.mCUSD, CELO.mCELO, CELO.mcEURO, CELO.cUSD, CELO.cEURO, CELO.cBTC],
}
...
export const COMMON_BASES: ChainTokenList = {
  ...
  [ChainId.MATIC]: [...WRAPPED_NATIVE_ONLY[ChainId.MATIC], MATIC.USDC, MATIC.WBTC, MATIC.DAI, MATIC.WETH, MATIC.USDT, SUSHI[ChainId.MATIC]],
  [ChainId.FANTOM]: [...WRAPPED_NATIVE_ONLY[ChainId.FANTOM], FANTOM.DAI, FANTOM.USDC, FANTOM.WBTC, FANTOM.WETH, SUSHI[ChainId.FANTOM]],
  [ChainId.BSC]: [...WRAPPED_NATIVE_ONLY[ChainId.BSC], BSC.DAI, BSC.USD, BSC.USDC, BSC.USDT, BSC.BTCB, BSC.WETH, SUSHI[ChainId.BSC]],
  [ChainId.ARBITRUM]: [...WRAPPED_NATIVE_ONLY[ChainId.ARBITRUM]],
  [ChainId.XDAI]: [...WRAPPED_NATIVE_ONLY[ChainId.XDAI], XDAI.USDC, XDAI.USDT, XDAI.WBTC, XDAI.WETH, SUSHI[ChainId.XDAI]],
  [ChainId.AVALANCHE]: [...WRAPPED_NATIVE_ONLY[ChainId.AVALANCHE], AVALANCHE.DAI, AVALANCHE.USDT, AVALANCHE.WBTC, AVALANCHE.WETH, SUSHI[ChainId.AVALANCHE]],
  [ChainId.HARMONY]: [...WRAPPED_NATIVE_ONLY[ChainId.HARMONY], HARMONY.DAI, HARMONY.USDC, HARMONY.USDT, HARMONY.WETH, HARMONY.WBTC, SUSHI[ChainId.HARMONY]],
  [ChainId.HECO]: [
  ...
  [ChainId.OKEX]: [...WRAPPED_NATIVE_ONLY[ChainId.OKEX], OKEX.DAI, OKEX.USDC, OKEX.USDT, OKEX.WBTC, OKEX.WETH, SUSHI[ChainId.OKEX]],
  // [ChainId.CELO]: [
