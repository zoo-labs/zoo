          ...
          <div className="h-[300px] flex flex-col justify-center align-middle">
            ...
            <div className="flex items-center justify-center gap-7">
              <div className="flex flex-col items-center">
                <p className="text-5xl text-white font-medium">{timeLeft[0]}</p>
                <p className="text-muted">Hrs</p>
              </div>
              <div className="flex flex-col items-center">
                <p className="text-5xl text-white font-medium">{timeLeft[1]}</p>
                <p className="text-muted">Min</p>
              </div>
              <div className="flex flex-col items-center">
                <p className="text-5xl text-white font-medium">{timeLeft[2]}</p>
