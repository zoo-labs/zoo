...
const Filters: React.FC<FilterProps> = ({}) => {
  ...
  const timeFIlterOption = ['Recently added', 'Last 24 hours', 'Last 7 days', 'Last 30 days', 'Last 90 days']
    ...
    <div className="block w-full">
      <div className="lg:px-6 pt-16 pb-16 md:flex-col md:items-center lg:mx-auto lg:max-w-7xl">
                ...
                {['All Items', 'Eggs', 'Animals'].map((value, index) => {
                  ...
                  return (
                    <a
                      ...
                      style={{
                        background: active ? 'linear-gradient(180deg, #4B31AC 0%, #2703F8 100%)' : 'transparent',
                      }}
                      key={index}
                    >
                      {value}
            ...
            <div className="flex items-end justify-end w-full">
              ...
              >
                ...
                <span className="flex items-center justify-center pl-2">
                  {!filtering ? <Filter color="#878787" /> : <span className="text-[#878787] py-2">X</span>}
                </span>
              </button>
            </div>
          </div>
        ...
        <div>
          {/* Search + Filter */}
          <div
            className={`${!filtering ? 'hidden' : 'block'} border-t border-solid py-8`}
          ...
          >
            <div className="flex flex-col lg:flex-row flex-wrap lg:items-center lg:justify-between space-y-3 lg:space-y-0">
              <div className="w-full md:w-auto">
                <p className="mb-2 text-sm font-normal uppercase md:text-lg text-grey-400">PRICE</p>
                <div className="">
              ...
              <div className="w-full md:w-auto">
                <p className="mb-2 text-sm font-normal uppercase md:text-lg text-grey-400">YIELDS</p>
                <div className="">
                  <FormControl style={{ color: 'white', width: '100%' }}>
                    <Select
                      labelId="demo-simple-select-label"
              ...
              <div className="w-full md:w-auto">
                <p className="mb-2 text-sm font-normal uppercase md:text-lg text-grey-400">RARITY</p>
                <div className="">
                  <FormControl style={{ color: 'white', width: '100%' }}>
                    <Select
                      labelId="demo-simple-select-label"
              ...
              >
                <div className="w-[70%] lg:w-[100%]">
                  <div className="mb-2 text-sm font-normal uppercase md:text-lg text-grey-400">PRICE RANGE</div>
                  <PrettoSlider
                    ...
                    <div className="flex flex-col ">
                      ...
                      <a className="flex flex-col flex-grow py-4 no-underline cursor-pointer">
                        <div className="flex flex-col flex-grow">
                          <div className="flex mb-4 ">
                            <div className="mt-1 mr-auto font-semibold">
                              {item.name || 'Egg'} <span className="text-xs text-gray-500">(#{item.id || ''})</span>
                            </div>
                            <div
                        ...
                        <div className="flex items-center justify-between pt-4 mt-4 text-sm text-gray-800 border-t border-gray-700 border-solid ">
                          ...
                          <span className="text-white font-semibold">{item.supply}</span>
                        </div>
                      </a>
                    </div>
                  </div>
