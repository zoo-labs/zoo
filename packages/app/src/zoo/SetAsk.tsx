      ...
      {showSelectCurrency ? (
        ...
        <>
          <h2 className='mb-10 text-xl text-center'>
            Set Ask for {type} <span className='px-2 py-1 ml-1 text-xs font-bold text-black bg-gray-300 rounded-full lux-font AssetModal__token-id'>{tokenId}</span>
          </h2>
          ...
          <SetAskButton tokenType={type} tokenId={tokenId} amount={value} currencyToken={selectedCurrencyToken} offline={offline} />
          {/* <div className="pt-3">
            <Switch.Group>
