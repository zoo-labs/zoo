...
const Popups: FC = () => {
  ...
  return (
    <>
      <div
        className={`hidden md:block fixed right-[36px] max-w-[355px] w-full z-[100000] flex flex-col ${
      ...
      <div className="fixed md:hidden left-4 right-4 top-[88px] fit-content mb-[20px] z-[100000]">
        <div
