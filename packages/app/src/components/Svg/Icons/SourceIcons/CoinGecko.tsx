...
const Icon: React.FC<SvgProps> = (props) => {
  return (
    <Svg viewBox='0 0 276 276' {...props}>
      <svg id='Layer_1' data-name='Layer 1' xmlns='http://www.w3.org/2000/svg' viewBox='0 0 276 276'>
        <title>CoinGecko</title>
        <g id='Coin_Gecko_AI' data-name='Coin Gecko AI'>
          <path className='cls-1' fill='#8dc63f' d='M276,137.39A138,138,0,1,1,137.39,0h0A138,138,0,0,1,276,137.39Z' transform='translate(0 0)' />
          <path className='cls-2' fill='#f9e988' d='M265.65,137.44a127.63,127.63,0,1,1-128.21-127h0A127.65,127.65,0,0,1,265.65,137.44Z' transform='translate(0 0)' />
          <path
            className='cls-3'
            fill='#fff'
          ...
          <path
            ...
            transform='translate(0 0)'
          />
          <path className='cls-3' fill='#fff' d='M213.64,131.2a5.35,5.35,0,1,1-5.38-5.32A5.36,5.36,0,0,1,213.64,131.2Z' transform='translate(0 0)' />
          <path className='cls-5' d='M138.48,69.91c6.43.46,29.68,8,35.68,12.12-5-14.5-21.83-16.43-35.68-12.12Z' fill='#009345' transform='translate(0 0)' />
          <path className='cls-3' fill='#fff' d='M144.6,106.58a24.68,24.68,0,1,1-24.69-24.67h0a24.68,24.68,0,0,1,24.68,24.66Z' transform='translate(0 0)' />
          <path className='cls-6' fill='#58595b' d='M137.28,106.8a17.36,17.36,0,1,1-17.36-17.36h0A17.36,17.36,0,0,1,137.28,106.8Z' transform='translate(0 0)' />
          <path
            className='cls-4'
            fill='#8bc53f'
