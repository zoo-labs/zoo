...
export const Anchors: React.FC = () => {
  return (
    <>
        ...
        {Object.values(variants).map((variant) => {
          return (
            <Box key={variant} mb='32px'>
              {Object.values(scales).map((scale) => {
                return (
                  <Button as='a' href='https://app.starterApp.org' key={scale} variant={variant} scale={scale} external mr='8px'>
      ...
      <Box>
        <Button as='a' href='https://app.starterApp.org' mr='8px' external disabled>
          Disabled
        </Button>
        <Button as='a' href='https://app.starterApp.org' variant='secondary' external disabled>
          Disabled
        </Button>
      </Box>
    </>
