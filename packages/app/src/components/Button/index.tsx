...
const OUTLINED = {
  default: "bg-transparent opacity-80 hover:opacity-100",
  red: "bg-red bg-opacity-20 outline-red rounded-full text-red hover:bg-opacity-40 disabled:bg-opacity-20",
  blue: "bg-blue bg-opacity-20 outline-blue rounded-full text-blue hover:bg-opacity-40 disabled:bg-opacity-20",
  indigo:
