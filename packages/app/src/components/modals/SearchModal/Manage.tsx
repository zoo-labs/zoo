...
function Manage({
  ...
  return (
    <div className='flex flex-col max-h-[inherit]'>
      <ModalHeader onClose={onDismiss} title={i18n._(t`Manage`)} onBack={() => setModalView(CurrencyModalView.search)} />
      ...
      <div className='h-screen'>
        {tabIndex === 0 && (
          <AutoSizer disableWidth>{({ height }) => <ManageLists height={height} setModalView={setModalView} setImportList={setImportList} setListUrl={setListUrl} />}</AutoSizer>
        )}
