          ...
          <div className="py-6 space-y-4 bg-black rounded-3xl z-1">
            ...
            <div className="flex flex-wrap px-5 mt-1">
              ...
              {!account ? (
                ...
                <button
                  className="w-full h-10 text-base text-center text-white rounded-full shadow-sm bg-leader-board disabled:bg-opacity-80 disabled:cursor-not-allowed focus:outline-none"
                  onClick={async () => {
                    if (
                      bridgeState?.status === "MINTED" ||
                      bridgeState?.status === "TRANSFERING" ||
