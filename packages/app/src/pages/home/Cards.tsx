...
const CardsSection = () => {
  return (
    <div className="pt-32 pb-20 lg:max-w-7xl lg:mx-auto flex gap-8 items-center justify-center flex-wrap">
      {segments.map((segment, i) => (
        <div
          key={segment}
          className="relative rounded-xl border border-muted-50 bg-16 min-w-[300px] min-h-[280px] flex items-center justify-center"
        >
