   ...
   `,
    ...
    images: [
      ...
      //"https://res.cloudinary.com/diu8hjwwe/video/upload/v1644330488/zoo/sumatran-elephant_bowsev.mov",
      {
        ...
        upLimit: 120,
        lowLimit: 40,
        glb: "/models/ELEPHTEEN.glb",
        usdzFile: false,
        usdz: "/models/ELEPHANT_TEEN.usdz",
      },
      {
        cameraZ: 90,
        upLimit: 120,
  ...
  },
  {
    ...
    images: [
      ...
      //"https://res.cloudinary.com/diu8hjwwe/video/upload/v1644330489/zoo/clouded-leopard_tmjty9.mov",
      {
        ...
        lowLimit: 10,
        usdzFile: false,
        usdz: "/models/LEOPARD_YOUNG_TEEN.usdz",
