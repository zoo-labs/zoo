...
const Home: React.FC<HomeProps> = ({}) => {
  ...
  return (
    <main className="relative z-10 flex flex-col flex-grow w-full h-full p-0 m-0 space-y-4 rounded-lg lg:p-16 lg:m-4 lg:pr-0 lg:mr-0 filter drop-shadow">
      {/* <div className='flex flex-wrap items-end justify-center p-4 lg:p-0 lg:justify-start'>
        <div>
          <div
      ...
      <div
        ...
        className="absolute z-0 rounded-full bg-primary opacity-10 filter blur-3xl"
      ></div>
      <div
        style={{
          width: "50vw",
        ...
        className="absolute z-0 rounded-full bg-pink opacity-10 filter blur-3xl"
      ></div>
    </main>
  );
};
