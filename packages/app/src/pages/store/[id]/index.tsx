      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <div className="flex-1 px-4">
            <h2 className="text-2xl mb-4">Zoo Merch Top Rainy Days Collection 21</h2>
            ...
            <p className="text-gray-400 mb-4">
              ...
              consectetur adipiscing elit. Duis imperdiet tortor
						...
						<div className="flex gap-8 mb-8">
							...
							<button className="bg-green text-black py-2 px-6 rounded-sm font-semibold">Add To Cart</button>
						</div>
