...
const httpRinkProvider = new Web3.providers.HttpProvider(Rinkeby_URL, { timeout: 10000 } as HttpProviderOptions)
...
const httpBSCProvider = new Web3.providers.HttpProvider(BSC_TEST_URL, {timeout: 10000 } as HttpProviderOptions)
