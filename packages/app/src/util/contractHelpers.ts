...
// Addresses
import { getZooAddress, getZooAuctionAddress, getZooDropAddress, getZooFaucetAddress, getZooMarketAddress, getZooMediaAddress, getZooKeeperAddress } from 'util/addressHelpers'

// Import ABIs from contracts.json. All ABIs should be identical.
import ZooContracts from 'contracts.json'
const contracts = ZooContracts['1337']['hardhat']['contracts']
