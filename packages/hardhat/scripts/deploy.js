...
const main = async () => {
  ...
  const yourContract = await deploy("ZooToken"); // <-- add in constructor args like line 19 vvvv
  // use for local token bridging
  // const mockToken = await deploy("MockERC20") // <-- add in constructor args like line 19 vvvv

  //const yourContract = await ethers.getContractAt('ZooToken', "0xaAC799eC2d00C013f1F11c37E654e59B0429DF6A") //<-- if you want to instantiate a version of a contract at a specific address!
  ...
  */
  ...
  const yourContract = await deploy("ZooToken", [], {
