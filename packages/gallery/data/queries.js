...
/**
 * Returns gql query to retrieve specific Zoo post
...
/**
 * Returns gql query to retrieve all Zoo posts by owner
...
/**
 * Calculates maximum number of Zoo media items
 * @param {Object[]} users
 * @returns {Number} max number of Zoo media items
 */
