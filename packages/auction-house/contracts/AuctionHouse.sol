...
import { IMarket, Decimal } from "@zoolabs/contracts/dist/contracts/interfaces/IMarket.sol";
import { IMedia } from "@zoolabs/contracts/dist/contracts/interfaces/IMedia.sol";
...
contract AuctionHouse is IAuctionHouse, ReentrancyGuard {
     ...
     * Constructor
     */
    constructor(address _zoo, address _weth) public {
        require(
