...
import { Market, Media } from "@zoolabs/contracts/dist/typechain";
...
describe("AuctionHouse", () => {
  ...
  describe("#constructor", () => {
    ...
    it("should not allow a configuration address that is not the Zoo Media Protocol", async () => {
      const AuctionHouse = await ethers.getContractFactory("AuctionHouse");
      await expect(
